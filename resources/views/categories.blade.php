...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <div class="nav-section">
      ...
      <a href="categories.html" class="nav-item active"><svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="5" cy="6" r="2"/><circle cx="5" cy="12" r="2"/><circle cx="5" cy="18" r="2"/><line x1="10" y1="6" x2="20" y2="6"/><line x1="10" y1="12" x2="20" y2="12"/><line x1="10" y1="18" x2="20" y2="18"/></svg>Catégories</a>
    </div>
  </nav>
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px">
      ...
      <div style="background:white;border:1px solid #F0EDE8;border-radius:16px;overflow:hidden" class="fade-in fade-in-1">
        <div style="padding:20px;display:flex;align-items:center;gap:14px">
          ...
          <div style="flex:1">
            <div style="font-weight:600;font-size:0.9rem;margin-bottom:2px">Courses</div>
      ...
      <div style="background:white;border:1px solid #F0EDE8;border-radius:16px;overflow:hidden" class="fade-in fade-in-2">
        <div style="padding:20px;display:flex;align-items:center;gap:14px">
          <div style="width:48px;height:48px;background:#EFF6FF;border-radius:14px;display:flex;align-items:center;justify-content:center;font-size:1.4rem;flex-shrink:0">⚡</div>
          <div style="flex:1">
            <div style="font-weight:600;font-size:0.9rem;margin-bottom:2px">Factures</div>
            <div style="font-size:0.75rem;color:var(--muted)">3 dépenses ce mois</div>
          </div>
          <div style="display:flex;gap:6px">
            <button class="btn btn-ghost btn-sm" onclick="showToast('Mode édition','success')">✏️</button>
            <button class="btn btn-danger btn-sm" onclick="showToast('Catégorie supprimée','error')">✕</button>
        ...
        <div style="background:#F9FAFB;padding:12px 20px;border-top:1px solid #F0EDE8">
          <div style="display:flex;justify-content:space-between;font-size:0.75rem;margin-bottom:6px"><span style="color:var(--muted)">Total</span><span style="font-weight:700">193,20 €</span></div>
          <div class="progress-bar"><div class="progress-fill" style="width:17%;background:#1D4ED8"></div></div>
        </div>
      </div>

      <div style="background:white;border:1px solid #F0EDE8;border-radius:16px;overflow:hidden" class="fade-in fade-in-3">
        <div style="padding:20px;display:flex;align-items:center;gap:14px">
          <div style="width:48px;height:48px;background:#F0FFF4;border-radius:14px;display:flex;align-items:center;justify-content:center;font-size:1.4rem;flex-shrink:0">🏠</div>
          <div style="flex:1">
            <div style="font-weight:600;font-size:0.9rem;margin-bottom:2px">Loyer</div>
            <div style="font-size:0.75rem;color:var(--muted)">1 dépense ce mois</div>
          </div>
          <div style="display:flex;gap:6px">
            <button class="btn btn-ghost btn-sm" onclick="showToast('Mode édition','success')">✏️</button>
            <button class="btn btn-danger btn-sm" onclick="showToast('Catégorie supprimée','error')">✕</button>
        ...
        <div style="background:#F9FAFB;padding:12px 20px;border-top:1px solid #F0EDE8">
          <div style="display:flex;justify-content:space-between;font-size:0.75rem;margin-bottom:6px"><span style="color:var(--muted)">Total</span><span style="font-weight:700">800,00 €</span></div>
          <div class="progress-bar"><div class="progress-fill" style="width:70%;background:var(--sage-dark)"></div></div>
        </div>
      </div>

      <div style="background:white;border:1px solid #F0EDE8;border-radius:16px;overflow:hidden">
        <div style="padding:20px;display:flex;align-items:center;gap:14px">
          <div style="width:48px;height:48px;background:#F5F3FF;border-radius:14px;display:flex;align-items:center;justify-content:center;font-size:1.4rem;flex-shrink:0">🌐</div>
          <div style="flex:1">
            <div style="font-weight:600;font-size:0.9rem;margin-bottom:2px">Internet</div>
            <div style="font-size:0.75rem;color:var(--muted)">1 dépense ce mois</div>
          </div>
          <div style="display:flex;gap:6px">
            <button class="btn btn-ghost btn-sm" onclick="showToast('Mode édition','success')">✏️</button>
        ...
        <div style="background:#F9FAFB;padding:12px 20px;border-top:1px solid #F0EDE8">
          <div style="display:flex;justify-content:space-between;font-size:0.75rem;margin-bottom:6px"><span style="color:var(--muted)">Total</span><span style="font-weight:700">49,99 €</span></div>
          <div class="progress-bar"><div class="progress-fill" style="width:4%;background:#7C3AED"></div></div>
        </div>
      </div>

      <div style="background:white;border:1px solid #F0EDE8;border-radius:16px;overflow:hidden">
        <div style="padding:20px;display:flex;align-items:center;gap:14px">
          <div style="width:48px;height:48px;background:#FEF2F2;border-radius:14px;display:flex;align-items:center;justify-content:center;font-size:1.4rem;flex-shrink:0">🧹</div>
          <div style="flex:1">
            <div style="font-weight:600;font-size:0.9rem;margin-bottom:2px">Ménage</div>
            <div style="font-size:0.75rem;color:var(--muted)">1 dépense ce mois</div>
          </div>
          <div style="display:flex;gap:6px">
            <button class="btn btn-ghost btn-sm" onclick="showToast('Mode édition','success')">✏️</button>
        ...
        <div style="background:#F9FAFB;padding:12px 20px;border-top:1px solid #F0EDE8">
          <div style="display:flex;justify-content:space-between;font-size:0.75rem;margin-bottom:6px"><span style="color:var(--muted)">Total</span><span style="font-weight:700">34,60 €</span></div>
          <div class="progress-bar"><div class="progress-fill" style="width:3%;background:var(--red)"></div></div>
        </div>
      </div>
